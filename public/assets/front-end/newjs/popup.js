...
pifyJQ(document).ready(function() {
    var webHost = "";
    var cookiePifyRequestHost = getCookie("PifyApp-RequestHost");
    if (cookiePifyRequestHost != undefined && cookiePifyRequestHost != null && cookiePifyRequestHost != "") {
        ...
        pifyJQ.ajax({
            ...
            success: function(res) {
                if (res.code == 1) {
                    webHost = res.result;
                    setCookie("PifyApp-RequestHost", encodeURI(webHost), 15 * 24 * 60 * 60)
                }
            }
        })
    }
    pifyJQ("body").on("click", ".pify-form-bar-btn", function(e) {
    ...
    pifyJQ("body").on("click", ".close_popup", function() {
        ...
        success: function(res) {
            if (res.code == 1) {
                ...
                for (var i = 0; i < forms.length; i++) {
                        ...
                        if (publish != null && publish != undefined) {
                            switch (publish.pageType) {
                                ...
                                case "homepage":
                                    ...
                                    break;
                                case "exactly_url":
                                    if (fullPageUrl != publish.pageUrl) {
                                        showForm = false
                                    }
                                    break;
                                case "include_url":
                    ...
                    generatePopupButton("pifybutton#" + forms[i].formId, apprearance)
                }
                        ...
                        setTimeout(function() {
                            ...
                            if (formPopuped == undefined || formPopuped == null || apprearance.autoPopupSettings.nextShowinDay == 0) {
                                ...
                                if (apprearance.autoPopupSettings != undefined) {
                                    ...
                                    setCookie("pify-form-popuped-" + autoOpenForms[0], true, nextShowTime)
                                }
                            }
                        }, popupDelay)
                    }
...
function generatePopupButton(target, apprearance) {
    ...
    if (formId != "") {
        ...
        pifyJQ(target).html(btHtml);
        pifyJQ(target).addClass("loaded")
    }
}
...
function receiveMessage(event) {
    if (event.data != "" && typeof(event.data) == "string") {
        ...
        if (datas != null && datas.SubmittedFormId) {
            setCookie("form-submited-" + datas.SubmittedFormId, true, 365 * 24 * 60 * 60)
        }
    }
}