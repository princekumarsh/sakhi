    ...
    <div class="row">
        ...
        <section class="col-lg-9 col-md-9">
            ...
            <div class="d-flex justify-content-end mb-3">
                <button style="width:170px;font-size:18px;" class="btn btn-lg btn-primary"
                    onclick="window.location.href='http://localhost/sync/add-address'" id="add_new_address">Add new
                    address
                </button>
            </div>
            ...
            <div class="row g-3">
                <section class="col-lg-6 col-md-6">
                    <div class="card __shadow h-100">
                        <div class="card-header d-flex justify-content-between d-flex align-items-center">
                            ...
                            <div class="d-flex justify-content-between">
                                <a class="" title="Edit Address" id="edit"
                                    href="http://localhost/sync/account-address-edit/17" style="margin-right: 5px;">
                                    <i class="fa fa-edit fa-lg"></i>
                                </a>
                                <a class="" title="Delete Address"
                                    href="http://localhost/sync/account-address-delete?id=17"
                        ...
                        <div class="card-body">
                            <div class="font-name"><span>Prince Kumar</span>
                            </div>
                            <div><span class="font-nameA"> <strong>Phone :</strong> +918210600193</span>
                            </div>
                            <div><span class="font-nameA"> <strong>City :</strong> PATNA</span>
                            </div>
                            <div><span class="font-nameA"> <strong> Zip code :</strong> 800027</span>
                            </div>
                            <div><span class="font-nameA"> <strong> State :</strong> Meghalaya</span>
                            </div>
                            <div><span class="font-nameA"> <strong>Address :</strong> 140, East vishawakarma colony,
                                    khemnichak
                                    East vishawakarma colony, khemnichakk</span>
                            </div>
                        </div>
                    </div>
                </section>
