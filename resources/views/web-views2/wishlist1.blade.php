        ...
        <section class="col-lg-9 col-md-9" id="set-wish-list">
            ...
            <div class="axil-wishlist-area axil-section-gap">
                <div class="container">
                    ...
                    <div class="table-responsive bg-pink" style="border: 1px solid #CBD3D9;border-radius: 6px !important;">
                            ...
                            <tbody>
                                <tr style="margin-left:10px;">
                                    <td class="product-remove">
                                        <a href="javascript:" onclick="removeWishlist('32')"
                                            class="remove-wishlist text-danger"><i class="fal fa-times"></i></a>
                                    </td>
                                    <td class="product-thumbnail"><a
                                            href=""
                                            class="d-block h-100">
                                            <img class="__img-full"
                                                src="{{asset('public/assets/front-end/img/pt1.jpg')}}"
                                                onerror="this.src='http://localhost/sync/public/assets/front-end/img/image-place-holder.png'"
                                                alt="wishlist">
                                        </a></td>
                                    <td class="product-title"><a
                                            href="">Bracelet for Sagittarius(Dhanu) November 21–December </a></td>
                                    <td class="product-price" data-title="Price"> <strike style="color: #E96A6A;" class="mr-3">
                                            ₹999.0
                                        </strike>
                                        <span class="font-weight-bold amount">₹499.0</span>
                                    </td>
                                    <td class="product-stock-status" data-title="Status">In Stock</td>
                                    <td class="product-add-cart"><a
                                            href=""
                                            class="axil-btn btn-outline">Buy Now</a></td>
                                </tr>
                                <tr style="margin-left:10px;">
                                    <td class="product-remove">
                                        <a href="javascript:" onclick="removeWishlist('31')"
                                            class="remove-wishlist text-danger"><i class="fal fa-times"></i></a>
                                    </td>
                                    <td class="product-thumbnail"><a
                                            ...
                                            class="d-block h-100">
                                            <img class="__img-full"
                                                src="{{asset('public/assets/front-end/img/pt4.jpg')}}"
                                                onerror="this.src='http://localhost/sync/public/assets/front-end/img/image-place-holder.png'"
                                                alt="wishlist">
                                        </a></td>
                                    <td class="product-title"><a
                                            href="http://localhost/sync/product/syncbel-led-night-lamp-05w-NRZ54j">Healing Crystal Astrology Chakra Stone</a></td>
                                    <td class="product-price" data-title="Price"> <strike style="color: #E96A6A;" class="mr-3">
                                            ₹1299.0
                                        </strike>
                                        <span class="font-weight-bold amount">₹799.0</span>
                                    </td>
                                    <td class="product-stock-status" data-title="Status">In Stock</td>
                                    <td class="product-add-cart"><a
                                            href="http://localhost/sync/product/syncbel-led-night-lamp-05w-NRZ54j"
