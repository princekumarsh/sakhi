                    ...
                    <div class="axil-dashboard-order">
                        <div class="table-responsive bg-pink" style="border: 1px solid #cbd3d9;border-radius: 6px !important;">
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        <th scope="row"><span class="marl">Refund related</span></th>
                                        <td><span>2023-10-10 04:03 PM</span></td>
                                        <td><span class="">Complaint</span></td>
                                        <td><span class="">Close</span></td>
                                        <td><a href="http://localhost/sync/support-ticket/1"
                        ...
                        <div class="mt-3">
                            <button onclick="window.location.href='http://localhost/sync/add-ticket'"
                                class="btn btn-lg btn-primary float-right" style="width:160px; font-size:18px;">
                                Add new ticket
                            </button>
                        </div>
                    </div>
