...
<div class="container">
    <div class="row">
        ...
        <!-- Content  -->
        <div class="col-xl-9 bg-pink col-md-8">
            <div class="tab-content">
                <div class="tab-pane active show" id="nav-account" role="tabpanel">
                    <div class="col-lg-9">
                        <div class="axil-dashboard-account">

                            <form class="account-details-form" action="http://localhost/sync/change-password" method="post" enctype="multipart/form-data">

                                <input type="hidden" name="_token" value="9bPxnl40Q0rGz9T9js2DWsMyCssLk8u9WrWxpFVB">                            <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label class="blable">New Password</label>
                                            <input class="form-control" name="password" type="password" id="password" required="">
                                        </div>
                                        <div class="form-group">
                                            <label class="blable">Confirm New Password</label>
