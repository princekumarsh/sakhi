            ...
            <div class="card __card">
                ...
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table __table">
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <td class="tdBorder">
                                        <div class="py-2"><span class="d-block spandHeadO">Transaction type </span>
                                        </div>
                                    </td>
                                    <td class="tdBorder">
                                        <div class="py-2"><span class="d-block spandHeadO">Credit </span>
                                        </div>
                                    </td>
                                    <td class="tdBorder">
                                        <div class="py-2"><span class="d-block spandHeadO"> Debit</span></div>
                                    </td>
                                    <td class="tdBorder">
                                        <div class="py-2"><span class="d-block spandHeadO"> Balance</span></div>
                                    </td>
                                    <td class="tdBorder">
                                        <div class="py-2"><span class="d-block spandHeadO"> Date</span></div>
                                    </td>
                                </tr>
                            </thead>
                        ...
                        <center class="mt-3 mb-2">No transaction found</center>
