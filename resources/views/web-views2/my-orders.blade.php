...
<style>
    ...
    .card {
        background-color: #E0CAEB !important;
    }
    ...
    <div class="row">
        ...
        <div class="col-xl-9 col-md-8">
            <div class="tab-content">
                <div class="tab-pane active show" id="nav-orders" role="tabpanel">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>₹399.0 for 1 items</td>


                                        <td><a href="http://localhost/sync/account-order-details?id=100029"
                                                class="axil-btn view-btn">Details</a></td>
                                        <td><a href="http://localhost/sync/track-order/result?order_id=100029&amp;from_order_details=1"
                                                class="axil-btn view-btn">Track</a></td>
                                        <td><a href="javascript:"
                                                onclick="route_alert('./order-cancel/100029','Want to cancel this order ')"
                                                class="axil-btn view-btn cancel">Cancel</a></td>
                                    </tr>

                                </tbody>
                                <tbody>
                                    <tr>
                                        <th scope="row">100028</th>


                                        <td class="col-2 for-tab-img">
                                            <img class="d-block"
                                                onerror="this.src='{{asset('public/assets/front-end/img/placeholder.png')}}'"
                                                src="{{asset('public/assets/front-end/img/p2.1.webp')}}"
                                                alt="VR Collection" width="60">
                                        </td>


                                        <td>2023-10-11 16:34:17</td>
                                        <td>
                                        ...
                                        <td>₹648.0 for 2 items</td>


                                        <td><a href="http://localhost/sync/account-order-details?id=100028"
                                                class="axil-btn view-btn">Details</a></td>
                                        <td><a href="http://localhost/sync/track-order/result?order_id=100028&amp;from_order_details=1"
                                                class="axil-btn view-btn">Track</a></td>
                                        <td><a href="javascript:"
                                                onclick="route_alert('./order-cancel/100028','Want to cancel this order ')"
                                                class="axil-btn view-btn cancel">Cancel</a></td>
                                    </tr>
                                ...
                                <tbody>
                                    <tr>
                                        <th scope="row">100025</th>


                                        <td class="col-2 for-tab-img">
                                            <img class="d-block"
                                                onerror="this.src='{{asset('public/assets/front-end/img/placeholder.png')}}'"
                                                src="{{asset('public/assets/front-end/img/p3.1.webp')}}"
                                                alt="VR Collection" width="60">
                                        </td>


                                        <td>2023-10-05 16:32:30</td>
                                        <td>
                                        ...
                                        <td>₹555.0 for 6 items</td>


                                        <td><a href="http://localhost/sync/account-order-details?id=100025"
                                                class="axil-btn view-btn">Details</a></td>
                                        <td><a href="http://localhost/sync/track-order/result?order_id=100025&amp;from_order_details=1"
                                                class="axil-btn view-btn">Track</a></td>
                                        <td><a href="javascript:"
                                                onclick="route_alert('./order-cancel/100025','Want to cancel this order ')"
                                                class="axil-btn view-btn cancel">Cancel</a></td>
                                    </tr>
