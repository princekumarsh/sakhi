...
<div class="container">
    <div class="row">
        ...
        <!-- Content  -->
        <div class="col-xl-9 col-md-8 bg-pink br5">
            <div class="tab-content">
                <div class="tab-pane active show" id="nav-account" role="tabpanel">
                    <div class="col-lg-9">
                        <div class="axil-dashboard-account">
                            <form class="account-details-form" action="http://localhost/sync/user-account-update" method="post" enctype="multipart/form-data">
                                <input type="hidden" name="_token" value="EcuJlzwoVJfWk3hTFkCN3HxrqMgJyfJ32n8912lr">                                <div class="axil-dashboard-author">
                                    <div class="media">
                                        <div class="thumbnail">
                                            <img id="blah" style="width: 70px;" class="rounded-circle border __inline-48" onerror="this.src='http://localhost/sync/public/assets/front-end/img/image-place-holder.png'" src="http://localhost/sync/public/assets/front-end/img/image-place-holder.png">
                                        </div>
                                        <div class="media-body">
                                            <h5 class="title mb-0">Hello prince</h5>
                                            <label class="blabel" for="files" class="lhov"><span class="joining-date">Change your profile pic</span></label>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label class="blable" for="firstName">First name </label>
                                            <input type="text" class="form-control " id="f_name" name="f_name" value="prince" required="">
                                            <label>First Name</label>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label class="blable" for="lastName"> Last name </label>
                                            <input type="text" class="form-control" id="l_name" name="l_name" value="kumar">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group mb--40">
                                            ...
                                            <input type="email" class="form-control" id="account-email" value="princekumarsh@gmail.com" disabled="">
                                         </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group mb--40">
                                            <label class="blable" for="phone">Phone number </label>
                                            <input type="number" class="form-control blable" id="phone" name="phone" value="8210600193" required="">
                                         </div>
                                    </div>
                                    <div class="col-12">
